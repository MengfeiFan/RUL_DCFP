function [xhk, pf] = particle_filter(sys,lambda_set, yk, pf, resampling_strategy)
...
% lambda_set =  a set of lambda values generated by MCMC
...
for i = 1:Ns
   ...
   lambda = lambda_set(i);
   xk(:,i) = sys(k, xkm1(:,i), lambda, pf.gen_sys_noise());
